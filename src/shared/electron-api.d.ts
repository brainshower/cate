...
export interface ElectronAPI {
  ...
  workspaceCreate(options?: { name?: string; rootPath?: string; id?: string; flashqueryConnection?: FlashQueryConnection }): Promise<WorkspaceMutationResult>
