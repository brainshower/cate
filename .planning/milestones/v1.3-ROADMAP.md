...
- ✅ **v1.3 Document Outline** — Phases 22-23 (shipped 2026-06-16)
...
**Goal:** Add Markdown preview heading IDs and route Outline navigation through preview scroll targets with accepted highlight behavior, then verify the full Outline workflow end to end.
...
2. Preview scroll accepts Outline heading text, strips Markdown inline formatting, finds the matching rendered heading, scrolls smoothly, and applies the accepted preview heading highlight.
...
v1.3 Document Outline shipped on 2026-06-16. Phase 22 and Phase 23 are implemented, verified, audited, and archived.
