# Requirements Archive: v1.3 Document Outline

**Archived:** 2026-06-16
**Status:** SHIPPED

Active requirements are cleared after milestone close. Start the next milestone with fresh requirements.
...
- [x] **REQ-018**: Markdown preview exposes a scroll-to-heading path that scrolls smoothly and applies the accepted preview heading highlight.

  Outcome note: Product clarification on 2026-06-16 accepts the current source-mode persistent highlight and current preview highlight timing/lifecycle. Source-mode highlight should remain after Outline navigation and clear naturally when the user edits. Preview-mode highlight may appear before/during auto-scroll and remain as currently implemented.
