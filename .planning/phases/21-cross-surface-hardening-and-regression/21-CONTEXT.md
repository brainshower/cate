...
- `.planning/phases/20-pi-mentions-and-clipboard-utilities/20-04-SUMMARY.md` - `T-E-004` mention E2E evidence, `T-E-003` clipboard preservation, and addendum noting `T-M-004` native clipboard verification is automated.
...
- `e2e/flashquery-native-clipboard.spec.ts` - `T-M-004` native clipboard coverage for vault tree, search row, and editor title copy actions.
...
- `T-M-004` is now automated by `e2e/flashquery-native-clipboard.spec.ts`; Phase 21 should treat native clipboard as covered unless that spec regresses.
