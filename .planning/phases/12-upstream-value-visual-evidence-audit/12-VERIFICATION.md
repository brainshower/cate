...
| REQ-018 | Passed | Upstream-smoke notes cover terminal/perf, editor fixes, file/git/workspace reload, build, and conditional packaged smoke. |
| REQ-020 | Passed | Removed-file decisions are current and import-safe: `skillTemplate.ts` retained, `BulkActionChip.tsx` removed. |
| REQ-022 | Passed | T-A-005 through T-A-009 visual review passed against current dark/light screenshots. |
...
| T-A-008 | Passed | Status chip visual review plus dark/light screenshots. |
...
| T-M-001 | Passed | Terminal/perf evidence recorded in `evidence/upstream-smoke/NOTES.md`. |
| T-M-002 | Passed | Editor smoke evidence recorded in `evidence/upstream-smoke/NOTES.md`; this row handled the Phase 11 REQ-013 carry-forward for upstream editor-fix coexistence. |
| T-M-003 | Passed | File explorer/git/workspace reload evidence recorded in `evidence/upstream-smoke/NOTES.md`. |
