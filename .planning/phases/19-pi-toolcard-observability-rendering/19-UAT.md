...
| REQ-017 | T-M-003 | Manual / real integration | Blocked | Live `call_model` observability was not executed in this environment because no confirmed configured Pi provider credentials, live FlashQuery runtime, and document-reference fixture were available to this executor. |
...
## T-M-003 Manual Procedure

To complete `T-M-003`, run Cate against a real configured FlashQuery instance and a native Pi provider:
...
Unavailable prerequisites in this execution environment:
