...
| 27-01-03 | 01 | 1 | REQ-003 | T-27-03 | Preload/shared include contract exposes graph summary without renderer privilege | unit | `npm run test:unit -- src/preload/index.test.ts` | yes | pending |
