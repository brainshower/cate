...
| 7 | Cross-cutting + regression | 1/3 | In Progress|  |
...
- [x] `04-02-PLAN.md` — Panel registration and app-store factory.
- [x] `04-03-PLAN.md` — Narrow renderer hooks for manual retry and future settings dialog open state.
- [x] `04-04-PLAN.md` — FlashQueryVaultPanel header, five states, lazy tree, row/context-menu behavior, refresh, and tests.
