...
- [x] 20-02-PLAN.md — Add AgentChatInput `@` mention dropdown and literal reference insertion.
- [x] 20-03-PLAN.md — Add vault tree and editor title clipboard utilities while preserving search row behavior.
